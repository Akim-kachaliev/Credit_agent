...
| Технология | Зачем |
|------------|-------|
| **Python 3.11** | Основной язык, на нём пишу |
| **FastAPI** | Делал API, удобно и быстро |
| **PostgreSQL** | Храню данные, надёжная БД |
| **SQLAlchemy** | Работа с базой через ORM |
| **Alembic** | Миграции, чтобы менять структуру БД |
| **Pydantic** | Проверка данных |
| **Docker** | Чтобы запускать везде одинаково |
| **Pytest** | Тесты, чтобы не сломать |
